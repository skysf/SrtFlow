...
| 落点 | 拖进来**原样落下**，不按工程总长自动裁短（不自作主张）；**左边缘对齐指针**（2026-09-23 从中点对齐改过来，理由见[拖文件进轨道](2026-09-22-media-file-drop.md)「指针对齐素材的左边缘」）；在两条音频轨之间的缝上停一下，缝拉开、松手在那儿新开一条（2026-09-24，[插入缝](2026-09-24-track-insert-and-reorder.md)） |
